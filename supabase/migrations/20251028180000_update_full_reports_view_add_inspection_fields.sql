/*
  Update full_reports view to include extra inspection fields
  (building_license_no, plan_no, land_use, onsite_services, parcel_no,
   neighbor_built, land_nature, is_occupied)
*/
